...
class AMIEventHandler:
    ...
    @staticmethod
    async def _update_database_session_by_id(session_id: str, updates: Dict[str, Any]):
    ...
    @staticmethod
    async def _get_recent_active_sessions(minutes: int = 5):
    ...
    async def register_handlers(self, tenant_id: int) -> AMIConnection:
    ...
    @staticmethod
    async def _update_database_session(session, updates: Dict[str, Any]):
    ...
    @staticmethod
    async def _get_default_tenant() -> Optional[str]:
